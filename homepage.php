...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="homepage/css/plugins/morris.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Welcome to Homepage!</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="homepage.php"><i class="fa fa-fw fa-dashboard"></i> Homepage</a>
                    </li>
                    <li>
                        <a href="itineraries.php"><i class="fa fa-fw fa-bar-chart-o"></i> Itineraries</a>
                    </li>
                    <li>
                        <a href="booking.php"><i class="fa fa-fw fa-table"></i> Booking</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <img src="sunset1.jpg" alt="Mountain View" style="max-width:100%;max-height:100%;">
                </div>
                <!-- /.row -->
